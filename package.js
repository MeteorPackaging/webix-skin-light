...
var packageName = 'webix:skin-light';  // https://atmospherejs.com/webix/skin-light
...
Package.describe({
  name: packageName,
  summary: 'Light skin for Webix UI',
  version: version,
  git: 'https://github.com/MeteorPackaging/webix-skin-light',
...
Package.onUse(function (api) {
  ...
  api.addFiles(['webix/codebase/skins/debug/light.css'], 'client');
